...
import { ChildComponent } from '../enfant/enfant.component';
  ...
  template: `
    <div class="container my-5 p-5 bg-warning-subtle">
      ...
      <div class="mb-3">
        ...
        <button class="btn btn-danger me-2" (click)="decreaseCounter()">
          -
        </button>
        <span class="badge bg-secondary">{{ counterParent }}</span>
        <button class="btn btn-success ms-2" (click)="increaseCounter()">
          +
        </button>
      </div>
